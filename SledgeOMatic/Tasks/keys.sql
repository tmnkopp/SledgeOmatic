...
SELECT MIN(PK_Question), MAX(PK_Question) FROM vwQuestions WHERE PK_FORM = '2024-Q3-CIO'  
SELECT MIN(FK_FormPage), MAX(FK_FormPage) FROM vwQuestions WHERE PK_FORM = '2024-Q3-CIO' 
SELECT MIN(PK_QuestionGroup), MAX(PK_QuestionGroup) FROM vwQuestions WHERE PK_FORM = '2024-Q3-CIO'   
...
SELECT * FROM vwQuestions WHERE PK_FORM='2024-Q4-MFA' 
